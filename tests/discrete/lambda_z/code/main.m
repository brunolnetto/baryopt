...
delta_first = [deltas_lambdaz{1}(:, 1), ...
               deltas_lambdaz{1}(:, 2)];
delta_multi = [deltas_lambdaz{2}(:, 1), ...
               deltas_lambdaz{3}(:, 1), ...
               deltas_lambdaz{4}(:, 1), ...
               deltas_lambdaz{2}(:, 2), ...
               deltas_lambdaz{3}(:, 2), ...
...
zbars_first = [zbars_lambdaz{1}(:, 1), ...
               zbars_lambdaz{1}(:, 2)];
zbars_multi = [zbars_lambdaz{2}(:, 1), ...
               zbars_lambdaz{3}(:, 1), ...
               zbars_lambdaz{4}(:, 1), ...
               zbars_lambdaz{2}(:, 2), ...
               zbars_lambdaz{3}(:, 2), ...
...
x_first = [xs_lambdaz{1}(:, 1), ...
           xs_lambdaz{1}(:, 2)];
x_multi = [xs_lambdaz{2}(:, 1), ...
           xs_lambdaz{3}(:, 1), ...
           xs_lambdaz{4}(:, 1), ...
           xs_lambdaz{2}(:, 1), ...
           xs_lambdaz{3}(:, 1), ...
